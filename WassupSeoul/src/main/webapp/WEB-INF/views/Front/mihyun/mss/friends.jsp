...
<body>
  ...
  <div class="back">
    ...
    <button type="button" class="iconImg">
      <img src="../img/msgicon2.png" alt="" width="50px">
    </button>
        ...
        <div class="tabBox">
          <ul class="nav nav-tabs nanum">
            <li class="nav-item col-md-4">
              <a class="nav-link active" data-toggle="tab" href="#home">친구목록</a>
            </li>
            <li class="nav-item col-md-4">
              <a class="nav-link" data-toggle="tab" href="#profile">친구대화</a>
            </li>
            <li class="nav-item col-md-4">
              <a class="nav-link" data-toggle="tab" href="#dropdown1">친구요청</a>
            </li>
          </ul>
        </div>


        <div id="myTabContent" class="tab-content" style="overflow:auto; height: 500px;">
          <div class="tab-pane fade show active" id="home">

            <div class="nanum">
              <br>
              <img src="../img/usericon.png" width="40px" height="40px" class="ml-3" data-toggle="modal"
                data-target="#profilePicture" style="cursor:pointer">
              &nbsp;
              <span class="" style="font-size: 20px;">안중하</span>
              &nbsp;
              <button type="button" class="btn btn-outline-danger btn-sm nanum float-right mr-3" data-toggle="modal"
                data-target="#blockBtn">차단</button>
              <button type="button" class="btn btn-outline-info btn-sm nanum float-right mr-3" id="chatBtn">대화</button>
            </div>
            ...
            <div class="nanum">
              ...
              <button type="button" class="btn btn-outline-danger btn-sm nanum float-right mr-3" data-toggle="modal"
                data-target="#blockBtn">차단</button>
              <button type="button" class="btn btn-outline-info btn-sm nanum float-right mr-3">대화</button>
            </div>
            <hr>
          ...
          <div class="tab-pane fade" id="profile">
            ...
            <div class="nanum mt-3 ml-3">
              ...
              <div class="chatPf" style="display: inline-block;">
                <img src="../img/usericon.png" width="40px" height="40px" class="chatProfile" data-toggle="modal"
                  data-target="#profilePicture" style="cursor:pointer"> &nbsp;
              </div>

              <div class="chatCt" style="display: inline-block;">
                <span>김지원</span>
                <span class="mr-0">: 마뭐하노 뭐하는데 연락이 안되는데...</span>
              </div>
          ...
          <div class="tab-pane fade" id="dropdown1">
            <div class="nanum mt-3 ml-3">
              <img src="../img/usericon.png" width="40px" height="40px" data-toggle="modal"
                data-target="#profilePicture" style="cursor:pointer"> &nbsp;
              <span>조미현님이 친구요청을 하셨습니다.</span>&nbsp;
              <button class="btn btn-info btn-sm nanum">수락</button>
              <button class="btn btn-danger btn-sm nanum" data-toggle="modal" data-target="#nopeBtn">거절</button>
            </div>
            <hr>
            <div class="nanum ml-3">
              <img src="../img/usericon.png" width="40px" height="40px" data-toggle="modal"
                data-target="#profilePicture" style="cursor:pointer"> &nbsp;
              <span>백동현님이 친구요청을 하셨습니다.</span>&nbsp;
              <button class="btn btn-info btn-sm nanum">수락</button>
              <button class="btn btn-danger btn-sm nanum" data-toggle="modal" data-target="#nopeBtn">거절</button>
            </div>
            <hr>
          ...
          <div class="tab-pane chat nanum" id="chat">
            ...
            <div id="div_chat">
              ...
              <br>
              <div class="nanum ml-3">
                <img src="../img/usericon.png" width="30px" height="30px" data-toggle="modal"
                  data-target="#profilePicture" style="cursor:pointer"> &nbsp;
                <span>김태훈</span>
                <br>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="font-size: 20px;">
          <form action="">
            ...
            <span class="nanum">님을 차단하셨습니다.</span>
          </form>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-danger nanum">차단목록</button>
          <button type="button" class="btn btn-primary nanum" data-dismiss="modal">확인</button>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body" style="font-size: 20px;">
          <form action="">
            <div>
              <img src="../img/usericon.png" width="200px" height="200px" class="ml-5 mr-5 mt-5 mb-3">
            </div>
            <div class="nanum text-center" style="font-size: 35px;">
              <span class="">안중하</span>
            </div>
            <div class="nanum text-center" style="font-size: 20px; color: darkblue;">
              <span class="">남성</span>
              <span class="">31세</span>
            </div>
            <br>
            <div class="nanum text-center" style="font-size: 20px; color: brown;">
              <span class="">#축구</span>
              <span class="">#영화</span>
              <span class="">#자전거</span>
            </div>
