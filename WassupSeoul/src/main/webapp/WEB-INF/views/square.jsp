          ...
          <div id="createStreet">
            <div class="form-group" style="display: inline-block;">
              <select class="custom-select nanum">
                <option selected value="0">인기 골목 순</option>
      ...
      <div class="col-md-2">
        ...
        <div id="myTabContent" class="tab-content">
          <ul class="list-group streetBtn tab-pane fade active show" id="gangnam">
            ...
            <li class="list-group-item list-group-item-action streetBtn">관악구</li>
            <li class="list-group-item list-group-item-action streetBtn">동작구</li>
            <li class="list-group-item list-group-item-action streetBtn">서초구</li>
            <li class="list-group-item list-group-item-action streetBtn">송파구</li>
            <li class="list-group-item list-group-item-action streetBtn">양천구</li>
            <li class="list-group-item list-group-item-action streetBtn">영등포구</li>
          </ul>
          <ul class="list-group streetBtn tab-pane fade" id="gangbuk">
            <li class="list-group-item list-group-item-action streetBtn">강북구</li>
            <li class="list-group-item list-group-item-action streetBtn">광진구</li>
            <li class="list-group-item list-group-item-action streetBtn">노원구</li>
            <li class="list-group-item list-group-item-action streetBtn">도봉구</li>
            <li class="list-group-item list-group-item-action streetBtn">동대문구</li>
            <li class="list-group-item list-group-item-action streetBtn">마포구</li>
            <li class="list-group-item list-group-item-action streetBtn">서대문구</li>
            <li class="list-group-item list-group-item-action streetBtn">성동구</li>
            <li class="list-group-item list-group-item-action streetBtn">성북구</li>
            <li class="list-group-item list-group-item-action streetBtn">용산구</li>
            <li class="list-group-item list-group-item-action streetBtn">은평구</li>
            <li class="list-group-item list-group-item-action streetBtn">중구</li>
            <li class="list-group-item list-group-item-action streetBtn">중랑구</li>
            <li class="list-group-item list-group-item-action streetBtn">종로구</li>
          </ul>
        </div>
      </div>
      <div class="col-md-10">
